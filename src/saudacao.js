...
// Além disso, a saudação só deve ser exibida se o usuário estiver 
// logado (`isLogged` for `true`). Se não estiver logado, a função não deve retornar nada.
